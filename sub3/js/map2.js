 window.onload = function() {
    ...
    var options = {
        center: new daum.maps.LatLng(37.66143690305519, 127.07614065479935),
        level: 2
    };
    ...
    var markerPosition  = new daum.maps.LatLng(37.66143690305519, 127.07614065479935); 
    ...
    var options2 = {
        center: new daum.maps.LatLng(37.66163352033172, 127.07512084653732),
        level: 2
    };
    ...
    var markerPosition2  = new daum.maps.LatLng(37.66163352033172, 127.07512084653732); 
   ...
   var options3 = {
       center: new daum.maps.LatLng(37.661206399290464, 127.0772992563757),
       level: 2
   };
   ...
   var markerPosition3  = new daum.maps.LatLng(37.661206399290464, 127.0772992563757); 
